...
moretrees.coloredtreelist = {
    {"crimson",     S("Crimson")},
    {"azure",       S("Azure")},
    {"springgreen", S("Spring Green")},
    {"hotpink",     S("Hot Pink")},
    {"galion",      S("Galion")},
    {"blueberry",   S("Blueberry"),  "skipleaves"},
    {"yellow",      S("Yellow")},
    {"magenta",     S("Magenta")},
}
	...
	if treename ~= "jungletree"  -- the default game provides jungle tree and pine trunk/planks nodes.
		...
		minetest.register_node("moretrees:"..treename.."_leaves", {
			...
			drop = {
				max_items = 1,
				items = {
					{items = {"moretrees:"..treename.."_sapling"}, rarity = 50 },
...
for i in ipairs(moretrees.coloredtreelist) do
	local treecolor = moretrees.coloredtreelist[i][1]
    local colorname = moretrees.coloredtreelist[i][2]
    local skipleaves = moretrees.coloredtreelist[i][3]
    minetest.register_node("moretrees:"..treecolor.."_trunk", {
        description = colorname .. " Tree Trunk",
        tiles = {  "moretrees_"..treecolor.."_trunk_top.png",
				   "moretrees_"..treecolor.."_trunk_top.png",
				   "moretrees_"..treecolor.."_trunk.png",
                },
        paramtype2 = "facedir",
        is_ground_content = false,
        groups = {tree=1,snappy=1,choppy=2,oddly_breakable_by_hand=1,flammable=2},
    ...
    minetest.register_node("moretrees:"..treecolor.."_planks", {
        description = colorname .. " Planks",
        tiles = { "moretrees_" .. treecolor .. "_wood.png"},
        is_ground_content = false,
        groups = {snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
        sounds = default.node_sound_wood_defaults(),
    })
    minetest.register_craft({
        type = "shapeless",
        output = "moretrees:"..treecolor.."_planks 4",
        recipe = { "moretrees:"..treecolor.."_trunk", },
    })

    stairs.register_slab(treecolor .. "_planks",
                         "moretrees:" .. treecolor .. "_planks",
                         { snappy=1, choppy=2, oddly_breakable_by_hand=2, flammable=3, wood=1,
                           not_in_creative_inventory = 1 },
                         { "moretrees_" .. treecolor .. "_wood.png" },
                         colorname .. " Plank Slab",
                         default.node_sound_wood_defaults(),
                         false)
    stairs.register_stair(treecolor .. "_planks",
                          "moretrees:" .. treecolor .. "_planks",
                          { snappy=1, choppy=2, oddly_breakable_by_hand=2, flammable=3, wood=1,
                            not_in_creative_inventory = 1 },
                          { "moretrees_" .. treecolor .. "_wood.png" },
                          colorname .. " Plank Stair",
                          default.node_sound_wood_defaults(),
                          false)

    if not skipleaves then
       local moretrees_new_leaves_drawtype = "allfaces_optional"
	   local moretrees_leaves_inventory_image = nil
	   local moretrees_new_leaves_waving = nil
       local moretrees_plantlike_leaves_visual_scale = 1
	   if moretrees.plantlike_leaves then
	      moretrees_leaves_inventory_image = minetest.inventorycube("moretrees_"..treecolor.."_leaves.png")
	      moretrees_new_leaves_drawtype = "plantlike"
	      moretrees_plantlike_leaves_visual_scale = math.sqrt(2)
	   else
	     moretrees_new_leaves_waving = 1
	   end
       minetest.register_node("moretrees:"..treecolor.."_leaves", {
          description = colorname .. " Leaves",
	      drawtype = moretrees_new_leaves_drawtype,
          waving = moretrees_new_leaves_waving,
          visual_scale = moretrees_plantlike_leaves_visual_scale,
	      tiles = { "moretrees_"..treecolor.."_leaves.png" },
	      inventory_image = moretrees_leaves_inventory_image,
	      paramtype = "light",
	      is_ground_content = false,
	      groups = {snappy = 3, flammable = 2, leaves = 1, moretrees_leaves = 1, leafdecay = 1},
	      ...
	      drop = {
		    max_items = 1,
	        items = {
	            {items = {"default:sapling"}, rarity = 100 },
	            {items = {"moretrees:"..treecolor.."_leaves"} }
	        }
	     },
       })
    end
    if moretrees.enable_stairs then
        if minetest.get_modpath("moreblocks") then
            stairsplus:register_all(
                "moretrees",
                treecolor.."_trunk",
                "moretrees:"..treecolor.."_trunk",
                {
                    groups = { snappy=1, choppy=2, oddly_breakable_by_hand=2, flammable=3, not_in_creative_inventory=1 },
                    tiles = { "moretrees_"..treecolor.."_wood.png" },
                    description = colorname.." Planks",
                    drop = treecolor.."_planks",
                })
        elseif minetest.get_modpath("stairs") then
            stairs.register_stair_and_slab(
                "moretrees_"..treecolor.."_trunk",
                "moretrees:"..treecolor.."_trunk",
                { snappy=1, choppy=2, oddly_breakable_by_hand=1, flammable=2 },
                {   "moretrees_"..treecolor.."_trunk_top.png",
                    "moretrees_"..treecolor.."_trunk_top.png",
                ...
                colorname.." Trunk Stair",
                colorname.." Trunk Slab",
                default.node_sound_wood_defaults()
                )
           stairs.register_stair_and_slab(
                "moretrees_"..treecolor.."_planks",
                "moretrees:"..treecolor.."_planks",
                { snappy=1, choppy=2, oddly_breakable_by_hand=1, flammable=3 },
                {   "moretrees_"..treecolor.."_wood.png" },
                colorname.." Planks Stair",
                colorname.." Planks Slab",
                default.node_sound_wood_defaults()
                )
        end
     end
     if minetest.settings:get_bool("moretrees.enable_fences", true) then
        local fence = {
             description = colorname .. " Wood Fence",
             texture     = "moretrees_" .. treecolor .. "_wood.png",
             material    = "moretrees:"..treecolor.."_planks",
             groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
		     sounds = default.node_sound_wood_defaults(),
        }
        default.register_fence("moretrees:" .. treecolor .. "fence", table.copy(fence))
	    fence.description = colorname .. " Fence Rail"
	    default.register_fence_rail("moretrees:" .. treecolor .. "_fence_rail", table.copy(fence))

	    if minetest.get_modpath("doors") ~= nil then
		    fence.description = colorname .. " Fence Gate"
		    doors.register_fencegate("moretrees:" .. treecolor .. "_gate", table.copy(fence))
	    end
     end

     table.insert(moretrees.avoidnodes, "moretrees:"..treecolor.."_trunk")
end
