...
moretrees.crimsontree={
	axiom="FFFFFBFB",
	rules_a="[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fd]]////[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fd]]////[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fdd]]",
	rules_b="[&&&F[++^Fd][--&d]//d[+^d][--&d]]////[&&&F[++^Fd][--&d]//d[+^d][--&d]]////[&&&F[++^Fd][--&Fd]//d[+^d][--&d]]",
	rules_c="/",
	rules_d="F",
	trunk="moretrees:crimson_trunk",
	leaves="moretrees:crimson_leaves",
	angle=30,
	iterations=2,
	random_level=0,
	trunk_type="single",
...
moretrees.azuretree={
	...
	rules_c="[[T]&&G++f++ff++ff++ff++f--G++[d]G[d]G++G[d]G[d]G[d]G++G[d]G[d]G[d]G++G[d]G[d]G[d]G++G[d]G]G",
	rules_d="f",
	trunk="moretrees:azure_trunk",
	leaves="moretrees:azure_leaves",
	angle=45,
	iterations=0,
	random_level=0,
	trunk_type="single",
...
moretrees.springgreentree={
	axiom="FFFBFB",
	rules_a="[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fd]]////[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fd]]////[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fdd]]",
	rules_b="[&&&F[++^Fd][--&d]//d[+^d][--&d]]////[&&&F[++^Fd][--&d]//d[+^d][--&d]]////[&&&F[++^Fd][--&Fd]//d[+^d][--&d]]",
	rules_c="/",
	rules_d="F",
	trunk="moretrees:springgreen_trunk",
	leaves="moretrees:springgreen_leaves",
	angle=30,
	iterations=2,
	random_level=0,
	trunk_type="double",
...
moretrees.hotpinktree={
	axiom="FFFFFdddccA/FFFFFFcA/FFFFFFcB",
	rules_a="[&&&dddd^^ddddddd][&&&---dddd^^ddddddd][&&&+++dddd^^ddddddd][&&&++++++dddd^^ddddddd]",
	rules_b="[&&&ddd^^ddddd][&&&---ddd^^ddddd][&&&+++ddd^^ddddd][&&&++++++ddd^^ddddd]",
	rules_c="/",
	rules_d="F",
	trunk="moretrees:hotpink_trunk",
	leaves="moretrees:hotpink_leaves",
	angle=30,
	iterations=2,
	random_level=0,
	trunk_type="single",
...
moretrees.galiontree={
	axiom="FFFFFFBFBFB",
	rules_a="[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fd]]////[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fd]]////[&&&GGF[++^Fd][--&Fd]//Fd[+^Fd][--&Fdd]]",
	rules_b="[&&&F[++^Fd][--&d]//d[+^d][--&d]]////[&&&F[++^Fd][--&d]//d[+^d][--&d]]////[&&&F[++^Fd][--&Fd]//d[+^d][--&d]]",
	rules_c="/",
	rules_d="F",
	trunk="moretrees:galion_trunk",
	leaves="moretrees:galion_leaves",
	angle=30,
	iterations=2,
	random_level=0,
	trunk_type="single",
...
moretrees.blueberrytree={
	axiom="FFFFFAFFBF",
	rules_a="[&&&FFFFF&&FFFF][&&&++++FFFFF&&FFFF][&&&----FFFFF&&FFFF]",
	rules_b="[&&&++FFFFF&&FFFF][&&&--FFFFF&&FFFF][&&&------FFFFF&&FFFF]",
	trunk="moretrees:blueberry_trunk",
	...
	trunk_type="crossed",
	thin_branches=true,
	fruit="default:blueberry_bush_leaves_with_berries",
	fruit_chance=15,
}

moretrees.yellowtree={
	axiom="TTTdddddccccccccccRT[TGGGGT]"..
		"ccccc[&&a]ccccc[&&a]ccccc[&&a]ccccc[&&a]ccccc[&&a]ccccc[&&a]"..
		"GGccccc[&a]ccccc[&a]ccccc[&a]ccccc[&a]ccccc[&a]ccccc[&a]"..
		"GGccccc[a]ccccc[a]ccccc[a]ccccc[a]ccccc[a]ccccc[a]",
	rules_a="Gffb&bbb[++f--&ffff&ff][--f++&ffff&ff]&ff&ff&bb&bb&bb",
	...
	rules_c="/",
	rules_d="F",
	trunk="moretrees:yellow_trunk",
    fruit="moretrees:yellow_trunk",
    fruit_chance=8,
	leaves="moretrees:yellow_leaves",
	angle=18,
	iterations=1,
	random_level=0,
	trunk_type="single",
...
moretrees.magentatree={
	axiom="TFFAFBFBFBf",
	rules_a=nil,
	rules_b="[&&-F]d[&&+F]d[&&---F]d[&&+++F]cdc",
    rules_c="/",
    rules_d="&RR",
	trunk="moretrees:magenta_trunk",
	leaves="moretrees:magenta_leaves",
    fruit="moretrees:magenta_trunk",
	angle=45,
	iterations=2,
	random_level=5,
	trunk_type="double",
