...
minetest.register_craft({
	...
	type = "shapeless",
	recipe = {"default:glass", "moreblocks:sweeper"},
    -- Make the sweeper re-usable.
	replacements = {{"moreblocks:sweeper", "moreblocks:sweeper"}},
})

minetest.register_craft({
	type = "cooking", output = "moreblocks:clean_glass", recipe = "default:glass",
})
...
minetest.register_craft({
    output = "moreblocks:super_glow_glass 2",
    type = "shapeless",
    recipe = {"default:glass", "default:mese_crystal_fragment", "default:glass"},
})
minetest.register_craft({
    output = "moreblocks:clean_super_glow_glass 2",
    type = "shapeless",
    recipe = {"moreblocks:clean_glass", "default:mese_crystal_fragment", "moreblocks:clean_glass"},
})
minetest.register_craft({
	type = "cooking", output = "moreblocks:clean_super_glow_glass", recipe = "moreblocks:super_glow_glass",
})
...
minetest.register_craft({
	output = "moreblocks:clean_super_glow_glass",
	type = "shapeless",
	recipe = {"moreblocks:super_glow_glass", "moreblocks:sweeper"},
    -- Make the sweeper re-usable.
	replacements = {{"moreblocks:sweeper", "moreblocks:sweeper"}},
})
...
minetest.register_craft({
	type = "cooking", output = "default:desert_stone 9", recipe = "moreblocks:desert_cobble_compressed",
})
...
minetest.register_craft({
	type = "shapeless",
	output = "moreblocks:copperpatinablock",
