...
minetest.register_tool("farming:scythe_mithril", {
	...
	on_use = function(itemstack, placer, pointed_thing)
        ...
        -- Avoid premature harvest of crops that start dropping a seed part-way
        -- through their growth cycle but no actual crop until mature (e.g., cotton):
        local next = mname .. ":" .. pname .. "_" .. (sname + 1);
