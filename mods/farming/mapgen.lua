...
if minetest.get_modpath("dungeon_loot") ~= nil then
    dungeon_loot.register({name = "farming:peppercorn", chance = 0.10, count = {1, 20}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_barley", chance = 0.25, count = {1, 99}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_cotton", chance = 0.25, count = {1, 99}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_hemp", chance = 0.25, count = {1, 99}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_mint", chance = 0.1, count = {1, 6}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_oat", chance = 0.25, count = {1, 99}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_rice", chance = 0.25, count = {1, 99}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_rye", chance = 0.25, count = {1, 99}, y={-64, 2048}})
    dungeon_loot.register({name = "farming:seed_wheat", chance = 0.25, count = {1, 99}, y={-64, 2048}})
end
