...
minetest.register_node("travelnet:travelnet_wood", {

	description = S("Wood-Lined Travelnet-Box"),
	...
	tiles = travelnet.tiles_travelnet_wood,

	inventory_image = travelnet.travelnet_inventory_image_wood,
