...
travelnet.tiles_travelnet_wood = {
		"travelnet_travelnet_front_wood.png",  -- backward view
		"travelnet_travelnet_back_wood.png", -- front view
		"travelnet_travelnet_side_wood.png", -- sides :)
		"default_wood.png",  -- view from top
		"default_clay.png",  -- view from bottom
		}
...
travelnet.travelnet_inventory_image_wood = "travelnet_inv.png" -- TODO
