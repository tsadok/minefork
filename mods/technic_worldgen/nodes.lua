...
minetest.register_node(":technic:sulfur_block", {
    ...
    groups = { choppy=2, melty=2, snappy=1 },
...
minetest.register_node(":technic:chromium_polished", {
	description = S("Polished Chromium"),
	tiles = { "technic_chromium_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:zinc_polished", {
	description = S("Polished Zinc"),
	tiles = { "technic_zinc_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:iron_polished", {
	description = S("Polished Iron"),
	tiles = { "technic_iron_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:cast_iron", {
	description = S("Cast Iron"),
	tiles = { "technic_cast_iron.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:carbon_steel_polished", {
	description = S("Polished Carbon Steel"),
	tiles = { "technic_carbon_steel_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:stainless_steel_polished", {
	description = S("Polished Stainless Steel"),
	tiles = { "technic_stainless_steel_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})

minetest.register_node(":technic:tin_polished", {
	description = S("Polished Tin"),
	tiles = { "default_tin_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})

minetest.register_node(":technic:bronze_polished", {
	description = S("Polished Bronze"),
	tiles = { "default_bronze_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})

minetest.register_node(":technic:copper_polished", {
	description = S("Polished Copper"),
	tiles = { "default_copper_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})

-- The point of lacquered versions is they won't get patina if exposed to water.
minetest.register_node(":technic:copper_lacquered", {
	description = S("Lacquered Copper"),
	tiles = { "default_copper_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
...
-- The point of lacquered versions is they won't get patina if exposed to water.
minetest.register_node(":technic:copperblock_lacquered", {
	description = S("Lacquered Copper Block"),
...
minetest.register_node(":technic:gold_polished", {
	description = S("Polished Gold"),
	tiles = { "default_gold_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:iron_polished", {
	description = S("Polished Iron"),
	tiles = { "default_steel_polished.png" },
	is_ground_content = true,
	groups = {cracky=1, level=2},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_craft({
    output = "technic:sulfur_block",
    recipe = {
        { "technic:sulfur_lump", "technic:sulfur_lump", "technic:sulfur_lump" },
        { "technic:sulfur_lump", "technic:sulfur_lump", "technic:sulfur_lump" },
        { "technic:sulfur_lump", "technic:sulfur_lump", "technic:sulfur_lump" }
    },
})
minetest.register_craft({
    output = "technic:sulfur_lump 9",
    recipe = { { "technic:sulfur_block" } },
})
