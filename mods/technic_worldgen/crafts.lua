...
minetest.register_craft({
    output = "technic:zinc_polished 4",
    recipe = { { "technic:zinc_block", "technic:zinc_block" },
               { "technic:zinc_block", "technic:zinc_block" } },
})
minetest.register_craft({
    output = "technic:zinc_block 9",
    recipe = { { "technic:zinc_polished", "technic:zinc_polished", "technic:zinc_polished", },
               { "technic:zinc_polished", "technic:zinc_polished", "technic:zinc_polished", },
               { "technic:zinc_polished", "technic:zinc_polished", "technic:zinc_polished", }  },
})

minetest.register_craft({
    output = "technic:chromium_polished 4",
    recipe = { { "technic:chromium_block", "technic:chromium_block" },
               { "technic:chromium_block", "technic:chromium_block" } },
})
minetest.register_craft({
    output = "technic:chromium_block 9",
    recipe = { { "technic:chromium_polished", "technic:chromium_polished", "technic:chromium_polished", },
               { "technic:chromium_polished", "technic:chromium_polished", "technic:chromium_polished", },
               { "technic:chromium_polished", "technic:chromium_polished", "technic:chromium_polished", }  },
})

minetest.register_craft({
    output = "technic:iron_polished 4",
    recipe = { { "technic:wrought_iron_block", "technic:wrought_iron_block" },
               { "technic:wrought_iron_block", "technic:wrought_iron_block" } },
})
minetest.register_craft({
    output = "technic:wrought_iron_block 9",
    recipe = { { "technic:iron_polished", "technic:iron_polished", "technic:iron_polished", },
               { "technic:iron_polished", "technic:iron_polished", "technic:iron_polished", },
               { "technic:iron_polished", "technic:iron_polished", "technic:iron_polished", }  },
})

minetest.register_craft({
    output = "technic:cast_iron 4",
    recipe = { { "technic:cast_iron_block", "technic:cast_iron_block" },
               { "technic:cast_iron_block", "technic:cast_iron_block" } },
})
minetest.register_craft({
    output = "technic:cast_iron_block 9",
    recipe = { { "technic:cast_iron", "technic:cast_iron", "technic:cast_iron", },
               { "technic:cast_iron", "technic:cast_iron", "technic:cast_iron", },
               { "technic:cast_iron", "technic:cast_iron", "technic:cast_iron", }  },
})

minetest.register_craft({
    output = "technic:carbon_steel_polished 4",
    recipe = { { "technic:carbon_steel_block", "technic:carbon_steel_block" },
               { "technic:carbon_steel_block", "technic:carbon_steel_block" } },
})
minetest.register_craft({
    output = "technic:carbon_steel_block 9",
    recipe = { { "technic:carbon_steel_polished", "technic:carbon_steel_polished", "technic:carbon_steel_polished", },
               { "technic:carbon_steel_polished", "technic:carbon_steel_polished", "technic:carbon_steel_polished", },
               { "technic:carbon_steel_polished", "technic:carbon_steel_polished", "technic:carbon_steel_polished", }  },
})

minetest.register_craft({
    output = "technic:stainless_steel_polished 4",
    recipe = { { "technic:stainless_steel_block", "technic:stainless_steel_block" },
               { "technic:stainless_steel_block", "technic:stainless_steel_block" } },
})
minetest.register_craft({
    output = "technic:stainless_steel_block 9",
    recipe = { { "technic:stainless_steel_polished", "technic:stainless_steel_polished", "technic:stainless_steel_polished", },
               { "technic:stainless_steel_polished", "technic:stainless_steel_polished", "technic:stainless_steel_polished", },
               { "technic:stainless_steel_polished", "technic:stainless_steel_polished", "technic:stainless_steel_polished", }  },
})

minetest.register_craft({
    output = "technic:bronze_polished 4",
    recipe = { { "default:bronzeblock", "default:bronzeblock" },
               { "default:bronzeblock", "default:bronzeblock" } },
})
minetest.register_craft({
    output = "default:bronzeblock 9",
    recipe = { { "technic:bronze_polished", "technic:bronze_polished", "technic:bronze_polished", },
               { "technic:bronze_polished", "technic:bronze_polished", "technic:bronze_polished", },
               { "technic:bronze_polished", "technic:bronze_polished", "technic:bronze_polished", }  },
})

minetest.register_craft({
    output = "technic:copper_polished 4",
    recipe = { { "default:copperblock", "default:copperblock" },
               { "default:copperblock", "default:copperblock" } },
})
minetest.register_craft({
    output = "default:copperblock 9",
    recipe = { { "technic:copper_polished", "technic:copper_polished", "technic:copper_polished", },
               { "technic:copper_polished", "technic:copper_polished", "technic:copper_polished", },
               { "technic:copper_polished", "technic:copper_polished", "technic:copper_polished", }  },
})

minetest.register_craft({
    output = "technic:gold_polished 4",
    recipe = { { "default:goldblock", "default:goldblock" },
               { "default:goldblock", "default:goldblock" } },
})
minetest.register_craft({
    output = "default:goldblock 9",
    recipe = { { "technic:gold_polished", "technic:gold_polished", "technic:gold_polished", },
               { "technic:gold_polished", "technic:gold_polished", "technic:gold_polished", },
               { "technic:gold_polished", "technic:gold_polished", "technic:gold_polished", }  },
})

minetest.register_craft({
    output = "technic:tin_polished 4",
    recipe = { { "default:tinblock", "default:tinblock" },
               { "default:tinblock", "default:tinblock" } },
})
minetest.register_craft({
    output = "default:tinblock 9",
    recipe = { { "technic:tin_polished", "technic:tin_polished", "technic:tin_polished", },
               { "technic:tin_polished", "technic:tin_polished", "technic:tin_polished", },
               { "technic:tin_polished", "technic:tin_polished", "technic:tin_polished", }  },
})
