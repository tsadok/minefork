...
for _, row in ipairs(dye.dyes) do
	local color_id = row[1]
	local color_name = row[2]
    minetest.register_node("digtron:inventory_" .. color_id, {
    	description = S(color_name .. " Digtron Inventory Storage"),
    	_doc_items_longdesc = digtron.doc.inventory_longdesc,
    	_doc_items_usagehelp = digtron.doc.inventory_usagehelp,
    	_digtron_formspec = inventory_formspec,
    	groups = {cracky = 3, oddly_breakable_by_hand=3, digtron = 2, tubedevice = 1, tubedevice_receiver = 1},
    	drop = "digtron:inventory_" .. color_id,
    	sounds = digtron.metal_sounds,
    	paramtype2= "facedir",
    	drawtype = "nodebox",
    	node_box = {
    	...
    	tiles = {
    		"digtron_plate.png^digtron_crossbrace.png",
    		"digtron_plate.png^digtron_crossbrace.png",
    		"digtron_plate.png^digtron_crossbrace.png^digtron_storage_" .. color_id .. ".png",
    		"digtron_plate.png^digtron_crossbrace.png^digtron_storage_" .. color_id .. ".png",
    		"digtron_plate.png^digtron_crossbrace.png^digtron_storage_" .. color_id .. ".png",
    		"digtron_plate.png^digtron_crossbrace.png^digtron_storage_" .. color_id .. ".png",
    		},
    ...
    minetest.register_craft({
    	output = "digtron:inventory_" .. color_id,
    	recipe = {
    			{"","dye:" .. color_id,""},
    			{"dye:" .. color_id, "digtron:inventory", "dye:" .. color_id},
    			{"","dye:" .. color_id,""}
    			}
    })
end
