...
minetest.register_craftitem("technic:stone_dust", {
    description = S("Stone Dust"),
...
minetest.register_tool("technic:yellow_energy_crystal", {
	description = S("Yellow Energy Crystal"),
	inventory_image = minetest.inventorycube(
		"technic_diamond_block_yellow.png",
		"technic_diamond_block_yellow.png",
		"technic_diamond_block_yellow.png"),
...
if minetest.get_modpath("dungeon_loot") ~= nil then
    dungeon_loot.register({name = "technic:yellow_energy_crystal", chance = 0.1})
end
