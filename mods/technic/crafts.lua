...
minetest.register_craft({
	output = 'technic:yellow_energy_crystal',
	recipe = {
		{'default:goldblock', 'technic:battery',             'dye:yellow'},
		{'technic:battery',   'technic:blue_energy_crystal', 'technic:battery'},
		{'dye:yellow',        'technic:battery',             'default:goldblock'},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'glooptest:arol_ingot', 'technic:battery', 'dye:green'},
		{'technic:battery', 'technic:red_energy_crystal', 'technic:battery'},
		{'dye:green', 'technic:battery', 'glooptest:arol_ingot'},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'glooptest:kalite_lump', 'technic:battery', 'dye:red'},
		{'technic:battery', 'basic_materials:energy_crystal_simple', 'technic:battery'},
		{'dye:red', 'technic:battery', 'glooptest:kalite_lump'},
	}
})
