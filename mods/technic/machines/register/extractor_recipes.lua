...
--		{"default:dry_shrub",                 "dye:brown 1"},
        ...
        {"group:food_blueberry",              "dye:violet 3"},
        {"group:food_raspberries",            "dye:red 3"},
        {"group:food_blackberry",             "dye:black 2"},
        {"group:food_onion",                  "dye:yellow 2"},
        {"basic_materials:limestone_dust",    "dye:white 8"},
	}
	...
	for _, color in ipairs(dye.dyes) do
		minetest.clear_craft({
			type = "shapeless",
			recipe = {"group:flower,color_"..color[1]},
		})
		minetest.register_craft({
			type = "shapeless",
			output = "dye:"..color[1].." 1",
			recipe = {"group:flower,color_"..color[1]},
		})
	end
