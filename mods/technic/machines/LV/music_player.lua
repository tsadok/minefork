...
local function play_track(pos, track)
    -- TODO: this might be where we want to send a message indicating the track title
			...
			"label[0,4;"..minetest.formspec_escape(
				meta:get_int("active") == 0 and
                    ...
                    S("Current track %s"):format(meta:get_int("current_track")
                                                 --minetest.settings:get("technic.tracktitle_"
                                                 --                      .. (meta:get_int("current_track") or 0),
                                                 --                      "Track " .. (meta:get_int("current_track") or 0))
                                                 --      or "Track " .. (meta:get_int("current_track") or 0)
                                                       )).."]")
end
