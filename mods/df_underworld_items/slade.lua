...
minetest.register_craft({
    output = "df_underworld_items:slade_brick 4",
    recipe = { { "df_underworld_items:slade", "df_underworld_items:slade" },
               { "df_underworld_items:slade", "df_underworld_items:slade" },
             },
})
...
minetest.register_craft({
    output = "df_underworld_items:slade_wall 6",
    recipe = { { "df_underworld_items:slade_brick", "df_underworld_items:slade_brick", "df_underworld_items:slade_brick" },
               { "df_underworld_items:slade_brick", "df_underworld_items:slade_brick", "df_underworld_items:slade_brick" },
             },
})
...
minetest.register_craft({
    output = "df_underworld_items:slade_block 9",
    recipe = { { "df_underworld_items:slade", "df_underworld_items:slade", "df_underworld_items:slade" },
               { "df_underworld_items:slade", "df_underworld_items:slade", "df_underworld_items:slade" },
               { "df_underworld_items:slade", "df_underworld_items:slade", "df_underworld_items:slade" },
             },
})
