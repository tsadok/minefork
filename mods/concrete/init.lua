...
for _, colour in pairs(dye.dyes) do
   minetest.register_node("concrete:concrete_block_" .. colour[1], {
      description = colour[2] .. " Concrete",
      tiles = { "technic_concrete_block_" .. colour[1] .. ".png" },
      groups = { cracky=1, level=2, concrete=1 },
      sounds = default.node_sound_stone_defaults(),
   })
   minetest.register_craft({
	output = "concrete:concrete_block_" .. colour[1] .. " 6",
	recipe = {
		{'coloredsand:bsand_' .. colour[1], 'basic_materials:wet_cement', 'default:gravel'},
		{'basic_materials:steel_bar',       'basic_materials:wet_cement', 'basic_materials:steel_bar'},
		{'default:gravel',                  'basic_materials:wet_cement', 'coloredsand:bsand_' .. colour[1] },
	}
   })
end
