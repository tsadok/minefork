...
invsaw.nosawformspec =  "size[5,2]"..
			"label[0,0;You don't have a table saw in your inventory!\nYou need to have one in order to use this function.]"..
...
function invsaw.update_inventory(inv, name, amount)
	...
	-- Display:
	inv:set_list("output",
		table_saw:get_output_inv(modname, material, amount,
...
minetest.register_on_player_receive_fields(function(player,formname,fields)
	...
	if fields.saw then
		...
		local havesaw = player:get_inventory():contains_item("main","moreblocks:table_saw")
