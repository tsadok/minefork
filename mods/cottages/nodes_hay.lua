...
if(     minetest.registered_items["default:dirt_with_grass"]
  ...
  minetest.override_item("default:dirt_with_grass", {
	after_dig_node = function(pos, oldnode, oldmetadata, digger)
		...
		-- Prevent dirt from being multiplied this way (that is:
        -- since we already converted the dirt with grass into dirt
        -- in-place, don't also drop dirt as an item on the ground):
		return
	end,
  })
end
...
minetest.register_craft({
	...
	recipe = {{"cottages:hay", "cottages:hay"},
