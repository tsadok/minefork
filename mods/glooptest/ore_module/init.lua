...
minetest.register_node("glooptest:kalite_block", {
    description       = "Kalite Block",
    tiles             = { "glooptest_kalite_block.png" },
...
glooptest.ore_module.register_ore("glooptest", "alatro", "Alatro", {
	...
	tools = {
		...
		texture = {
            ...
            scythe = "gloopores_tool_alatroscythe.png"
		},
		caps = {
			sword = {
