...
stairs.register_stair("stone_mossy", "gloopblocks:stone_mossy", {cracky = 3}, {"gloopblocks_stone_mossy.png"}, "Mossy Stone Stair",
		default.node_sound_stone_defaults(), true)
stairs.register_stair_inner("stone_mossy", "gloopblocks:stone_mossy", {cracky = 3}, {"gloopblocks_stone_mossy.png"}, "",
		default.node_sound_stone_defaults(), true, "Inner " .. "Mossy Stone Stair")
stairs.register_stair_outer("stone_mossy", "gloopblocks:stone_mossy", {cracky = 3}, {"gloopblocks_stone_mossy.png"}, "",
		default.node_sound_stone_defaults(), true, "Outer " .. "Mossy Stone Stair")
stairs.register_slab("stone_mossy", "gloopblocks:stone_mossy", {cracky = 3}, {"gloopblocks_stone_mossy.png"}, "Mossy Stone Slab",
		default.node_sound_stone_defaults(), true)
...
-- These two are wanted for lava handling:
...
-- I actually like the mossy stone stuff, so we'll keep that:
...
-- 	end
	...
	if minetest.setting_getbool("gloopblocks_mossy_conversion") ~= false then
		...
		gloopblocks_register_mossy_conversion({
            ...
            { "default:copperblock",                    "moreblocks:copperpatinablock" },
            { "technic:copper_polished",                "moreblocks:copperpatina" },
...
-- No, that is wrong, and it causes this server crash:
-- ERROR[Main]: ServerError: AsyncErr: ServerThread::run Lua: "gloopblocks:stair_stone_mossy" is not a registered node!
-- The stairs and such are registered under the stairs: mod, even the mossy ones, so:
			{ "default:stair_stone", 					"stairs:stair_stone_mossy" },
			{ "default:slab_stone", 					"stairs:slab_stone_mossy" },
			{ "moreblocks:stair_stone", 				"stairs:stair_stone_mossy" },
			{ "moreblocks:stair_stone_inner", 			"stairs:stair_stone_mossy_inner" },
			{ "moreblocks:stair_stone_outer", 			"stairs:stair_stone_mossy_outer" },
			{ "moreblocks:stair_stone_half", 			"stairs:stair_stone_mossy_half" },

			{ "moreblocks:slab_stone_quarter", 			"stairs:slab_stone_mossy_quarter" },
			{ "moreblocks:slab_stone", 					"stairs:slab_stone_mossy" },
			{ "moreblocks:slab_stone_three_quarter",	"stairs:slab_stone_mossy_three_quarter" },
			{ "moreblocks:panel_stone", 				"gloopblocks:panel_stone_mossy" },
			{ "moreblocks:micro_stone", 				"gloopblocks:micro_stone_mossy" },
			{ "moreblocks:stair_stone_alt", 			"stairs:stair_stone_mossy_alt" },
		})
	end
