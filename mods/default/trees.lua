...
function default.grow_sapling(pos)
    ...
    local hallelujah = tonumber(minetest.setting_get("cloudlands_altitude")) or 200
	if node.name == "default:sapling" then
		minetest.log("action", "A sapling grows into a tree at "..
			minetest.pos_to_string(pos) .. "(y=" .. pos.y .. ") [where cloudlands_altitude="..hallelujah.."]")
		if mg_name == "v6" then
			default.grow_tree(pos, random(1, 4) == 1)
        elseif pos.y >= hallelujah then
