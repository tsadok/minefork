...
minetest.register_node("default:sandstone", {
	...
	groups = {crumbly = 1, cracky = 3, naturalsandstone=1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:sandstonebrick", {
	...
	is_ground_content = false,
	groups = {cracky = 2, naturalsandstone=1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:olivine", {
	description = S("Olivine"),
	tiles = {"olivine.png"},
	groups = {cracky = 3, stone = 1 },
	is_ground_content = true,
	drop = "default:olivine",
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:sand", {
	...
	groups = {crumbly = 3, falling_node = 1, sand = 1, naturalsand=1},
