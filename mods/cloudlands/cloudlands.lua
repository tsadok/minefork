...
local NODENAMES_SILT        = {"mapgen_silt", "default:silt", "technic:silt", "aotearoa:silt", "darkage:silt", "mapgen_sand", "mcl_core:sand", "default:sand", "main:sand"} -- silt isn't a thing yet, but perhaps one day it will be. Use sand for the bottom of ponds in the meantime.
...
if minetest.get_modpath("dungeon_loot") ~= nil then
    dungeon_loot.register({name = "cloudlands:HeartWood", chance = 0.2, y={16384, 32768}})
end
